      ...
      <div class="title clearfix">
        ...
        <div class="fr">
          <ul class="nav-tabs clearfix">
            <li :class="(active = i == 0 ? 'active' : '')" v-for="(item, i) in list.navList" :key="i">
      ...
      <div class="tab-content">
        <div class="tab-pane">
          <div class="floor-1">
            <div class="blockgary">
              <ul class="jd-list">
                <li v-for="(item, i) in list.keywords" :key="i">{{ item }}</li>
              </ul>
              <img :src="list.imgUrl" />
            </div>
            <div class="floorBanner">
              ...
              <my-carsouse :imglist="list.carouselList"></my-carsouse>
            </div>
            <div class="split">
